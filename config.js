...
const zeroXData = {
  ...
  // MUSTER
  2121337: {
    exchange: "0x9a6204dE86443eB0914059b291f667D8953e8aE1",
    wrappedNativeToken: "0xd9eF5BE1AB8AC56325eDd51f995BBCa0eBE7D9e8",
  },
}
...
NETWORKS.forEach((network) => {
  const networkZerox = zeroXData[network.chainId.toString()]

  if (networkZerox) {
    const hexaId = `0x${parseInt(network.chainId.toString()).toString(16)}`
    const explorer = network.explorers ? network.explorers[0] : null
    map[network.chainId] = {
      ...
      wrappedNativeToken: {
        ...
        address: networkZerox.wrappedNativeToken,
      },
      zeroExEchance: networkZerox.exchange
    }
  }
})


console.log(Object.values(zeroXData).length)
