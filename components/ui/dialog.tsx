...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/15 backdrop-blur-sm focus:outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
  ...
  (
    {
      ...
      shouldDisplayCloseBtn = true,
      ...props
    },
    ref
  ) => (
    <DialogPortal>
      {shouldDisplayOverlay && <DialogOverlay />}
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "dialog fixed left-[50%] top-[50%] z-50 grid max-h-[100%] w-[calc(100%-20px)] max-w-[600px] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-auto p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:top-[50%] sm:w-full sm:translate-y-[-50%] sm:p-8",
          className
        )}
        {...props}
      >
